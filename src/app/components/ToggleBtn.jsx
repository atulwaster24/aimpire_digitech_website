...
const SwitchTheme = ({ toggleTheme, theme }) => {
  ...
  return (
    ...
    <input type="checkbox" checked={isChecked} onChange={handleCheckboxChange} className="sr-only" />
        <div className="shadow-card border-2 border-ButterflyBlue dark:border-TheNewBlack flex h-auto w-auto items-center justify-center rounded-full ">
          
          <span
            
            className={`flex h-6 w-6 items-center justify-center rounded-full ${
              theme === 'light' ? "bg-ButterflyBlue text-white" : "text-body-color"
            }`}
          >
            <svg
              width="14"
          ...
          <span
            className={`flex h-6 w-6 items-center justify-center rounded-full  ${
              theme === 'dark' ? "bg-TheNewBlack text-white" : "text-black"
            }`}
          >
            <svg
              width="14"
